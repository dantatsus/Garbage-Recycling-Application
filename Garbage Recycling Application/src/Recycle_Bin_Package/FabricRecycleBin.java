...
public class FabricRecycleBin<G extends Garbage> extends RecycleBin<G> implements IBag<G> {
	
	private final String type = "FABRIC";
	...
	public void displayItems() {
		System.out.println(" ");
		System.out.println("Fabric Recycle Bin Object: ");
